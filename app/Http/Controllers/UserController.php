...
class UserController extends Controller
{
    ...
    public function storeUser(Request $request) {
        ...
        return redirect()->to('/')->with('message', 'User created & logged in successfully! 🧙‍♂️');
    }
    ...
    public function authenticate(Request $request) {
        ...
        if (empty($request->username1) || empty($request->password1)) {
            return redirect()->to('/')->withErrors(['username1' => 'Invalid Credentials! 🧟‍♂️'])->onlyInput('username1');
        }
        ...
        return redirect()->to('/')->with('message', 'User logged in successfully! 🧙‍♂️');
    }
    ...
    public function logoutUser(Request $request) {
        ...
        return redirect()->to('/')->with('message', 'User logged out successfully! 🧟');
    }
}